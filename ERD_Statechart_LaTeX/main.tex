...
Ba điểm bổ sung: (1) \textit{in lại} không đổi trạng thái -- bản in là dữ kiện một khi đã đúng thì đúng mãi, mỗi lần in chỉ ghi Activity Log; (2) nếu booking bị huỷ hoặc quá hạn check-in trước khi ký, hợp đồng gốc (Draft/Printed) bị Closed theo policy hoàn cọc, không treo lơ lửng; (3) quá hạn ký phụ lục \textit{không có terminal} -- nhắc việc lặp vô hạn định, vì EndDate đã dịch ngay từ khi trả phí nên phụ lục chỉ còn là hồ sơ giấy. Sơ đồ gộp vòng đời hai loại hợp đồng: guard loại hợp đồng ghi ở từng chuyển dịch (type = ORIGINAL cho bản gốc, type = ADDENDUM cho phụ lục).
...
Signed & rental kích hoạt [type = ORIGINAL] & Active & Hợp đồng gốc có hiệu lực \\ \hline
...
Draft & addendum gia hạn [phí đã trả, type = ADDENDUM] & AwaitingSignature & Auto-draft phụ lục; \attr{ParentContractID} trỏ gốc \\ \hline
...
Signed & addendum đã filed [type = ADDENDUM] & $[\circ]$ & Phụ lục hoàn tất hồ sơ giấy \\ \hline
...
stateDiagram-v2
    ...
    Draft --> Closed : booking huy / qua han check-in
                        [hoan coc theo policy]
    ...
    note right of AwaitingSignature
        ...
        EndDate da dich tu khi tra fee,
